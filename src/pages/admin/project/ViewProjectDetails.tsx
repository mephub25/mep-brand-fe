          ...
          <div className="p-8 border-b border-gray-200">
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
              <div className="flex-1">
                <h1 className="text-xl font-bold text-gray-900 mb-4">{project.name}</h1>
...
{project.activities && project.activities.length > 0 && (
  <div className="p-8">
    ...
    <p className="text-gray-700 text-sm mb-6 leading-relaxed">
      Below is an overview of the key activities our company carried out as part of this project. 
      These tasks highlight the major steps, contributions, and deliverables completed during project execution.
    </p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {project.activities.map((act: any) => (
        <div
          key={act._id}
          className="bg-gray-50 rounded-xl p-4 transition-colors duration-200"
        >
